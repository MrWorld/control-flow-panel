...
const CarManufacturer = () => {
  ...
  const getMyList = async () => {
    if (!checkPermission("CAR_MANUFACTURER:READ")) return true;
    let data = { take, page };
    ...
    try {
      const response = await adminService.getCarManufacturers(data);
      setLoading(false);
  ...
  return (
    ...
    >
      <PageTitleWrapper>
        <PageHeader
          pageTitle="Car Manufacturer"
          pageSubtitle="You can see list of car canufacturer here"
