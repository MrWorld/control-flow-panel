                ...
                {resultData.map((data) => {
                  return (
                    <TableRow hover key={data.id}>
                      ...
                      <TableCell>
                        <Box dir={'rtl'}>
                          <Typography fontWeight="700">{data.cardNumber}</Typography>
                        </Box>
                      </TableCell>
                      <TableCell>
                        <Box dir={'rtl'}>
                      ...
                      <TableCell align="right">
                        <Typography noWrap>
                          <Tooltip title={"View"} arrow>
                            <IconButton
                              disabled={!checkPermission("COMPANY:UPDATE")}
                              onClick={() =>
                                checkPermission("COMPANY:UPDATE") &&
                                navigate(
                                  ROUTE_CONSTANTS.DASHBOARD.MASTERS.COMPANY.GET_BY_DATA(data.id).ABSOLUTE,
                                  { state: data }
                                )
                              }
                          ...
                          <Tooltip title={"Delete"} arrow>
                            <IconButton
                              disabled={!checkPermission("COMPANY:DELETE")}
