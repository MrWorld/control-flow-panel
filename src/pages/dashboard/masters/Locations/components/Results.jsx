                      ...
                      <TableCell align="right">
                        <Typography noWrap>
                          <Tooltip title={"View"} arrow>
                            <IconButton
                              disabled={!checkPermission("PARKING_LOCATION:UPDATE")}
                              onClick={() =>
                                checkPermission("PARKING_LOCATION:UPDATE") &&
                                navigate(
                                  ROUTE_CONSTANTS.DASHBOARD.MASTERS.PARKING_LOCATION.GET_BY_DATA(data.id).ABSOLUTE,
                                  { state: data }
                                )
                              }
                          ...
                          <Tooltip title={"Delete"} arrow>
                            <IconButton
                              disabled={!checkPermission("PARKING_LOCATION:DELETE")}
