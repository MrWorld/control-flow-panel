...
import './GlobalCssAccordion.css';
SwiperCore.use([Navigation, Thumbs]);

export default function BookingAccordionDetails({ data }) {
  const [expanded, setExpanded] = useState('panel1');
  const theme = useTheme()
  const [showPicture, setShowPic] = useState(false);
  ...
  return (
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} variant="outlined" className='booking-accordion'>
        <AccordionSummary
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} variant="outlined" className='booking-accordion'>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} variant="outlined" className='booking-accordion'>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} variant="outlined" className='booking-accordion'>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
      ...
      <Dialog open={showPicture} onClose={() => setShowPic(false)}>
        <DialogContent>
