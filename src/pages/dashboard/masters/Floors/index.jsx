...
const ParkingFloor = () => {
  ...
  const getMyList = async () => {
    if (!checkPermission("PARKING_FLOOR:READ")) return true;
    let data = { take, page };
    ...
    try {
      const response = await adminService.getFloors(data);
      setLoading(false);
  ...
  return (
    ...
    >
      <PageTitleWrapper>
        <PageHeader
          pageTitle="Parking Floors"
          pageSubtitle="You can see list of parking floor here"
