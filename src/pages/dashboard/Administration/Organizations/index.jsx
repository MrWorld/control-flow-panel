...
const Organizations = () => {
  ...
  const getMyList = async () => {
    if (!checkPermission("ORGANIZATION:READ")) return true;
    let data = { page, take };
    ...
    try {
      const response = await adminService.getOrganizations(data);
      setLoading(false);
    ...
    >
      <PageTitleWrapper>
        <PageHeader
          ...
          pageSubtitle="You can see list of organization here"
