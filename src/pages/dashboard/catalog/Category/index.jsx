...
const Category = () => {
  ...
  const getMyList = async () => {
    ...
    // data['filter'] = filter
    try {
      const response = await adminService.getCatalogCategoriesList(data);
      setLoading(false);
    ...
    >
      <PageTitleWrapper>
        <PageHeader
          ...
          pageSubtitle="You can see list of Categories here"
          ...
          {loading ? (
            ...
            <Results
              ...
              actions={{
                ...
                handleSearchCategory: handleChangeSearch,
              }}
              itemPartitions={{
                toggle: true,
                image: true,
