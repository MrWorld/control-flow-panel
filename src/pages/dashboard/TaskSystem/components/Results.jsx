                    ...
                    <TableRow hover key={data.id}>
                      ...
                      <TableCell>
                        <Box dir={"rtl"}>
                          <Typography fontWeight="700">
                            <Chip
                              label={StatusMaker({ status: data.status }).name}
                              style={{
                                background: StatusMaker({ status: data.status })
                                  .color,
                                color: 'white'
                              }}
                            ></Chip>
                        ...
                        <Typography noWrap>
                          <Tooltip title={"View"} arrow>
                            <IconButton
                              onClick={() =>
                                navigate(
                                  ROUTE_CONSTANTS.DASHBOARD.TASK.GET_BY_DATA(
                                    data.id
                                  ).ABSOLUTE,
                                  { state: data }
                                )
