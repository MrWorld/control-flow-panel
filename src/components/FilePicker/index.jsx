...
import ImageListForPicker from "./Components/ImageListPicker";
...
const FilePicker = ({
  ...
  const onSelectImage = async (e) => {
    ...
    reader.onload = function (e) {
      ...
      // const type = e.target.result.split(';')[0]?.split(':')[1];
      // console.log('type',type)
      // let image = new Blob([e.target.result], {type: type});
      console.log('we are here')
      // image.src = e.target.result;
      onSelectCoppedImage(files[0])
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            <Droppable droppableId="droppable" type="TASK">
              {(provided, snapshot) => (
                ...
                >
                  <ImageListForPicker images={imagesList}/>
